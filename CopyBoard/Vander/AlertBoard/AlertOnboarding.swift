...
open class AlertOnboarding: UIView, AlertPageViewDelegate {
    ...
    var arrayOfBottomTitles = [String]()
    
    fileprivate var buttonAction: ((Int) -> Bool)? = nil
    ...
    public init (arrayOfImage: [String], arrayOfTitle: [String], arrayOfDescription: [String], arrayOfBottomTitles: [String], buttonAction: @escaping (Int) -> Bool) {
        ...
        self.arrayOfBottomTitles = arrayOfBottomTitles
    ...
    fileprivate func configure() {
        ...
        self.buttonBottom.titleLabel?.font = appFont(size: 15)
